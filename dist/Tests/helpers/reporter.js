...
var Proccessor = /** @class */ (function (_super) {
    __extends(Proccessor, _super);
    function Proccessor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Proccessor.prototype.displayJasmineStarted = function (Informations, WriteLogging) {
        return "TypeScript ".concat(WriteLogging);
    };
    return Proccessor;
